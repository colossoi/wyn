...
pub struct KnownBuiltinIds {
    ...
    pub thread_id_y: BuiltinId,
    pub thread_id_z: BuiltinId,
    pub local_id: BuiltinId,
...
impl BuiltinCatalog {
    ...
    pub fn build(raw_defs: Vec<BuiltinDefRaw>) -> Self {
        ...
        let known = KnownBuiltinIds {
            ...
            thread_id_y: resolve(N::INTRINSIC_THREAD_ID_Y),
            thread_id_z: resolve(N::INTRINSIC_THREAD_ID_Z),
            local_id: resolve(N::INTRINSIC_LOCAL_ID),
