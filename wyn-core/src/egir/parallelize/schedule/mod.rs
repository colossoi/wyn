...
pub use crate::kernel_graph::{
    KernelDomain, KernelId, OutputRouteProjection, PhysicalKernel, PhysicalKernelGraph,
};
...
impl From<&KernelPlan> for PhysicalKernelGraph {
    fn from(plan: &KernelPlan) -> Self {
        ...
        .unwrap_or_else(|error| unreachable!("invalid finalized kernel plan: {error}"))
    }
}
