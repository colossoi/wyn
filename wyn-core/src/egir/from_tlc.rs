...
pub(crate) use crate::interface::lowering::build_entry_outputs;
use crate::interface::lowering::{entry_output_arity, is_storage_image_ty, InterfaceError};
pub use crate::interface::lowering::{extract_size_hint, AUTO_STORAGE_SET};
...
use crate::interface::{
    self, BindingExposure, EntryInput, EntryInputKind, EntryParamBinding, EntryParamBindingKind,
...
impl From<InterfaceError> for ConvertError {
